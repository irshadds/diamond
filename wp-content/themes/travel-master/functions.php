...
function my_taxonomies_recipies() {
  $labels = array(
    'name'              => _x( 'Recipes Categories', 'taxonomy general name' ),
    'singular_name'     => _x( 'Recipes Category', 'taxonomy singular name' ),
    'search_items'      => __( 'Search Recipes Categories' ),
    'all_items'         => __( 'All Recipes Categories' ),
    'parent_item'       => __( 'Parent Recipes Category' ),
    'parent_item_colon' => __( 'Parent Recipes Category:' ),
    'edit_item'         => __( 'Edit Recipes Category' ), 
    'update_item'       => __( 'Update Recipes Category' ),
    'add_new_item'      => __( 'Add New Recipes Category' ),
    'new_item_name'     => __( 'New Recipes Category' ),
  ...
  register_taxonomy( 'recipes_category', 'recipes', $args );
}
add_action( 'init', 'my_taxonomies_recipies', 0 );

function my_taxonomies_recipies_brand() {
  $labels = array(
  ...
  register_taxonomy( 'recipes_brand', 'recipes', $args );
}
add_action( 'init', 'my_taxonomies_recipies_brand', 0 );
